...
export class AppData implements InMemoryDbService {
  ...
  createDb(): { products: Product[], productCategories: ProductCategory[]} { //, productCategories: ProductCategory[], suppliers: Supplier[]} {
    const products = ProductData.products;
    const productCategories = ProductCategoryData.categories;

    //const productCategories = ProductCategoryData.categories;
    //const suppliers = SupplierData.suppliers;
    return { products, productCategories};  //, productCategories, suppliers };
  }
}
